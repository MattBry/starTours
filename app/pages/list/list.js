...
export class ListPage {
  static get parameters() {
    return [[NavController], [NavParams], [PlanetService]];
  }
  constructor(nav, navParams, planetService) {
    this.nav = nav;
    this.planets = [
        {
            "name": "Alderaan", 
  ...
  // ngOnInit() {
  //   return this.planetService.getPlanets().then(planets => this.planets = planets);
  // }
}
